...
- Cinq facteurs testés sont statistiquement associés à l'attrition (p < 0,05) : faire des heures supplémentaires (p ≈ 8·10⁻²¹, l'association la plus forte), le revenu mensuel (p ≈ 3,0·10⁻¹⁴), l'âge (p ≈ 5,3·10⁻¹¹), la satisfaction au poste (p ≈ 5,6·10⁻⁴) et le nombre d'années depuis la dernière promotion (p ≈ 0,041). Âge et revenu sont corrélés à `JobLevel`/`TotalWorkingYears`, donc à interpréter avec cette réserve.
